...
# DuckDB allows you to create a standalone Chroma service, but it will be much less scalable
# Chroma contains a telemetry feature that collects anonymous usage information set false
